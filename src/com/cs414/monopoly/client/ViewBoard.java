...
public class ViewBoard extends FlexTable {
	...
	LinkedHashMap<Integer, ViewSpace> mappings = new LinkedHashMap<Integer, ViewSpace>() {{
		...
		put(6, new ViewSpace(10,5, "maxStation", STYLE_NS));
		put(7, new ViewSpace(10,4, "cuppys", STYLE_NS));
		put(8, new ViewSpace(10,3, "chance", STYLE_NS));
		...
		put(16, new ViewSpace(5,0, "maxStation", STYLE_WE));
		...
		put(23, new ViewSpace(0,2, "chance", STYLE_NS));
		put(24, new ViewSpace(0,3, "humanBean", STYLE_NS));
		put(25, new ViewSpace(0,4, "dazBog", STYLE_NS));
		put(26, new ViewSpace(0,5, "maxStation", STYLE_NS));
		...
		put(36, new ViewSpace(5,10, "maxStation", STYLE_WE));
		put(37, new ViewSpace(6,10, "chance", STYLE_WE));
